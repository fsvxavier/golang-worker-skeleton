...
func ParseFormatToGo(format string) string {
	...
	formatGo = strings.Replace(formatGo, "YYYY", "2006", -1)
	formatGo = strings.Replace(formatGo, "MM", "01", -1)
	formatGo = strings.Replace(formatGo, "DD", "02", -1)
	formatGo = strings.Replace(formatGo, "HH", "15", -1)
	formatGo = strings.Replace(formatGo, "II", "04", -1)
	formatGo = strings.Replace(formatGo, "SS", "05", -1)
...
//	  - yyyy-mm-dd hh:ii:ss
//
func ParseDateTime(datetime string, format string, timezone string) (string, error) {
